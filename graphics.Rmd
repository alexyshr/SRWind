...
era5_4326_sf_pol_filter_very_good = era5_4326_sf_pol %>% filter(DN %in% c(1540,1491,224,2308,78))
...
ggplot(data = world) + 
  ...
  scale_fill_manual(values = c("Very Good: 5" = "orange"), name="Downscaling Support") + #, label=c("dd")) +  
