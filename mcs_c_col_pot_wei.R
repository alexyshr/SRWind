...
pf_beta_sheathing = apply(
                          ...
                          type_pdf_rvs = c("stats::qnorm", "stats::qnorm", "stats::qnorm", "stats::qnorm", "stats::qlnorm", "lmomco::quawei", "interpolation_hurricane"), #"stats::qnorm"),
...
pf_beta_shingles = apply(
                        ...
                        names_of_rvs = c("Kh", "Kd", "GCp", "GCpi", "R", "VNH", "VH"), #exposure, wind direction, external pressure, 
                        #internal pressure, capacity, velocity non hurricanes, velocity hurricanes
                        type_pdf_rvs = c("stats::qnorm", "stats::qnorm", "stats::qnorm", "stats::qnorm", "stats::qnorm", "lmomco::quawei", "interpolation_hurricane"), #"stats::qnorm"),
