...
pf_beta_sheathing = apply(h_nh_c, 1, mcs_wind,
                          ...
                          type_pdf_rvs = c("stats::qnorm", "stats::qnorm", "stats::qnorm", "stats::qnorm", "stats::qlnorm", "lmomco::quagpa", "interpolation_hurricane"), #"stats::qnorm"),
...
pf_beta_shingles = apply(h_nh_c, 1, mcs_wind,
                          ...
                          names_of_rvs = c("Kh", "Kd", "GCp", "GCpi", "R", "VNH", "VH"), #exposure, wind direction, external pressure, 
                          #internal pressure, capacity, velocity non hurricanes, velocity hurricanes
                          type_pdf_rvs = c("stats::qnorm", "stats::qnorm", "stats::qnorm", "stats::qnorm", "stats::qnorm", "lmomco::quagpa", "interpolation_hurricane"), #"stats::qnorm"),
