...
# 1 - POT PP
#
h_nh_c_file <- paste0(output_path, "/", "combined_h_nh_isla_pot_pp.xlsx")
#
#
# 2 - POT - GPA
#h_nh_c_file <- paste0(output_path, "/", "combined_h_nh_isla_pot_gpa.xlsx")
#h_nh_c_file <- paste0(output_path, "/", "combined_h_nh_isla_pot_gp.xlsx")

#

# 3 - POT - LN3
#h_nh_c_file <- paste0(output_path, "/", "combined_h_nh_isla_pot_ln3.xlsx")
#

# 4 - POT - GUM
#h_nh_c_file <- paste0(output_path, "/", "combined_h_nh_isla_pot_gum.xlsx")
#

# 5 - POT - WEI
#h_nh_c_file <- paste0(output_path, "/", "combined_h_nh_isla_pot_wei.xlsx")
#

# 6 - YM - GEV
#h_nh_c_file <- paste0(output_path, "/", "combined_h_nh_isla_ym_gev.xlsx")
#
...
h_nh_c = read.xlsx(xlsxFile=h_nh_c_file, sheet = "combined_h_nh")
...
#Create function to generate LHS samples and calculate probability of failure and Beta
...
pf_beta_sheathing = apply(
                    ...
                    type_pdf_rvs = c("stats::qnorm", "stats::qnorm", "stats::qnorm", "stats::qnorm", "stats::qlnorm", "evd::qgpd", "interpolation_hurricane"), #"stats::qnorm"),
...
pf_beta_shingles = apply(
                          ...
                          names_of_rvs = c("Kh", "Kd", "GCp", "GCpi", "R", "VNH", "VH"), #exposure, wind direction, external pressure, 
                          #internal pressure, capacity, velocity non hurricanes, velocity hurricanes
                          type_pdf_rvs = c("stats::qnorm", "stats::qnorm", "stats::qnorm", "stats::qnorm", "stats::qnorm", "evd::qgpd", "interpolation_hurricane"), #"stats::qnorm"),
